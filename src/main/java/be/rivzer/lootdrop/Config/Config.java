package be.rivzer.lootdrop.Config;
...
public class Config {
    ...
    public static void saveConfig1() {
        try {
            Config.getCustomConfig1().save(customConfigFile1);
    ...
    public static void createCustomConfig2() {
        customConfigFile2 = new File(plugin.getDataFolder(), "lootdrops.yml");
        if (!customConfigFile2.exists()) {
            customConfigFile2.getParentFile().mkdirs();
            plugin.saveResource("lootdrops.yml", false);
        }
    ...
    public static void saveConfig2() {
        try {
            Config.getCustomConfig2().save(customConfigFile2);
        } catch (IOException ee) {
            ee.printStackTrace();
        }
    }
    ...
    public static void createCustomConfig3() {
        customConfigFile3 = new File(plugin.getDataFolder(), "data.yml");
    ...
    public static void saveConfig3() {
        try {
            Config.getCustomConfig3().save(customConfigFile3);
        } catch (IOException ee) {
            ee.printStackTrace();
        }
    }
